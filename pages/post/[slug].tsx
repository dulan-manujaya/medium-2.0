...
function Posts({ post }: Props) {
  ...
  const onSubmit: SubmitHandler<IFormInmput> = async (data) => {
  ...
  useEffect(() => {
    setCreatedDate(new Date(post._createdAt).toLocaleString());
  }, [post]);
  console.log(post);
  return (
    <main>
      ...
      <article className="max-w-3xl mx-auto p-5">
        ...
        <h2 className="t-xl font-light text-gray-500 mb-2">
          {post.description}
        </h2>
      ...
      {submitted ? (
        ...
        >
          ...
          focus:shadow-outline focus:outline-none font-bold px-4 
